<?php
/**
 * Adds infinite next and previous posts.
 *
 * WordPress only shows next and previous buttons when the adjacent post is available. This function allows for inifite next and previous
 * by getting the first post if at the end and the last if at the beginning.
 *
 * @since 1.0
...
/**
 *
 * Returns markup for infinite buttons
 *
 * @param  string $insert_element Any additional elements to place inbetween plugins mark-up.
 * @param  string $previous_button_text			Description.
 * @param  string $next_button_text The text to show on the next button.
 * @return string Markup for entire html next and previous element
 */
